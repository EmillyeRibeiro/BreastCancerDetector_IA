...
# 🚀 AJUSTE CRÍTICO 1: Resolução Aumentada para maior detalhe
IMG_SIZE = (512, 512)
# 🚀 AJUSTE CRÍTICO 2: Batch Size reduzido para economizar VRAM
BATCH_SIZE = 8
EPOCHS = 50 
EPOCHS_PHASE_1 = 10 
...
BASE_MODEL, MODEL = build_resnet_model(input_shape, initial_learning_rate=1e-4) # LR inicial para a Fase 1
MODEL.summary()
...
cb = [
    ...
    callbacks.ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=3, min_lr=1e-8, verbose=1) # Min LR ajustado
]


# 8️⃣ Treinamento em Duas Fases (Fine-Tuning)
print(f"\n🚀 FASE 1: Treinando a Cabeça (Head) do Modelo por {EPOCHS_PHASE_1} épocas. (IMG_SIZE={IMG_SIZE}, BATCH_SIZE={BATCH_SIZE})")
print("=============================================================================================================")
...
# Mantemos 140 congeladas por precaução
